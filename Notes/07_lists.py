...
words.sort()#sorts with alphanumeric sorting, words and numbers don't mix well here
print(words)
...
seq = ['G', 'A', 'A', 'T', 'T', 'C']
s = ''.join(seq) #whatever you put in between the quotes will be used to join the string
print(s, seq)
